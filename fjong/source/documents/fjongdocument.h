...
#ifndef FJONGDOCUMENT_H
#define FJONGDOCUMENT_H
...
class FJONGDocument : public QWidget
{
    Q_OBJECT
public:
    FJONGDocument(QWidget* parent);
...
//    CIniFile* m_projectIniFile;
  ...
  //      Data::data.blink = true;
    ...
    virtual void InitDocument(CIniFile* ini) {
      //  m_updateThread = t;
        m_iniFile = ini;
